...
const ActiveConnectionInfo = props => {
    ...
    return (
        <div className={classes.ActiveConnectionInfo}>
            <span className={classes.HeadData}>{props.activeConnection.colorNumber} {props.activeConnection.crossSectionalArea}</span>
            ...
            {props.isFirstRole
                ...
                : props.markType !== null
                    ...
                    : <img src={`/img/typePrint${props.activeConnection.markType}.png`} alt=""/>
            }
            {!props.isFirstRole &&
                <div className={classes.completeInfo}>
                    <p><span>Выполнил: </span> {completeAuthor}</p>
                    <p><span>Дата: </span>{completeDate}</p>
                </div>
            }
        </div>
    )
