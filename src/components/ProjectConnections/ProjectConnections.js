        ...
        <div className={classes.ProjectConnections}>
            ...
            <ul>
                {props.project.connections.map((connection, index) => {
                    ...
                    return (
                        <Link to={'/project/' + props.projectId + '/' + connectionId} key={index}>
                            <li className={classes.ProjectConnections}
                                key={index}
                                onClick={() => {
                            ...
                            >
                                ...
                                <div className={classes.gridContainer}>
                                    ...
                                    <div className={classes.markType}>
                                        <img src={`/img/type${connection.markType}.png`}
                                             alt=""/>
                                    </div>
                                    ...
                                    <div className={classes.completeBlock}>
                                            <p className={classes.completeData}>{connection.completeDate}</p>
                                            <p className={classes.completeData}>{connection.completeAuthor}</p>
